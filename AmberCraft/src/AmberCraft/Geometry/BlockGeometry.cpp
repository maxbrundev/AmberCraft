...
std::vector<AmberCraft::Geometry::BlockVertex> AmberCraft::Geometry::BlockGeometry::m_vertices;
glm::vec3 AmberCraft::Geometry::BlockGeometry::m_positions[8];
glm::vec3 AmberCraft::Geometry::BlockGeometry::m_normals[6];
glm::vec2 AmberCraft::Geometry::BlockGeometry::m_uvs[4];
bool AmberCraft::Geometry::BlockGeometry::m_initialized = false;


void AmberCraft::Geometry::BlockGeometry::SetUp()
{
	if (!m_initialized)
	{
		m_initialized = true;
...
void AmberCraft::Geometry::BlockGeometry::InitializePositions()
{
	//    v6----- v5
	//   /|      /|
	//  v1------v0|
...
void AmberCraft::Geometry::BlockGeometry::InitializeNormals()
{
...
void AmberCraft::Geometry::BlockGeometry::InitializeUVs()
{
...
void AmberCraft::Geometry::BlockGeometry::InitCubeVertices()
{
	//Front
...
void AmberCraft::Geometry::BlockGeometry::CreateTriangle(uint8_t pos1, uint8_t pos2, uint8_t pos3, uint8_t text1, uint8_t text2, uint8_t text3, uint8_t p_normals)
{
...
void AmberCraft::Geometry::BlockGeometry::CreateFace(uint8_t pos1, uint8_t pos2, uint8_t pos3, uint8_t pos4, uint8_t text1, uint8_t text2, uint8_t text3, uint8_t text4, uint8_t p_normals)
{
	m_vertices.emplace_back(m_positions[pos1], m_uvs[text1], m_normals[p_normals]);
	m_vertices.emplace_back(m_positions[pos2], m_uvs[text2], m_normals[p_normals]);
	m_vertices.emplace_back(m_positions[pos3], m_uvs[text3], m_normals[p_normals]);
...
std::vector< AmberCraft::Geometry::BlockVertex>& AmberCraft::Geometry::BlockGeometry::GetVertices()
{
	return m_vertices;
}
